...
static  const u32 sMugshotImg_Ritz_1[] = INCBIN_U32("graphics/mugshots/ritz/mug_01.4bpp.lz");
static const u16 sMugshotPal_Ritz_1[] = INCBIN_U16("graphics/mugshots/ritz/mug_01.gbapal");
